...
<div class="center_content">
    ...
    <canvas bind:this={radarCurrenciesCanvas} id="radarCurrenciesCanvas" class="pt-4 pb-8 max-w-7xl"></canvas>

    <canvas bind:this={chartTransactionsCanvas} id="TransactionsChart" class="pt-4 pb-8 max-w-7xl"></canvas>
</div>